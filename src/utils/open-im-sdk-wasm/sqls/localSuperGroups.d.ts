...
export declare function insertSuperGroup(
  db: Database,
  group: ClientGroup,
): QueryExecResult[]
export declare function updateSuperGroup(
  db: Database,
  groupID: string,
  group: ClientGroup,
): QueryExecResult[]
export declare function deleteSuperGroup(
  db: Database,
  groupID: string,
): QueryExecResult[]
export declare function getSuperGroupInfoByGroupID(
  db: Database,
  groupID: string,
): QueryExecResult[]
