...
export declare function insertGroup(
  db: Database,
...
export declare function getGroupInfoByGroupID(
  db: Database,
  groupID: string,
): QueryExecResult[]
...
export declare function subtractMemberCount(
  db: Database,
  groupID: string,
): QueryExecResult[]
export declare function addMemberCount(
  db: Database,
  groupID: string,
): QueryExecResult[]
export declare function getGroupMemberAllGroupIDs(
  db: Database,
): QueryExecResult[]
