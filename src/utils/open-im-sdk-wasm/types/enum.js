...
;(function (MessageReceiveOptType) {
  ...
  MessageReceiveOptType[(MessageReceiveOptType['NotReceive'] = 1)] =
    'NotReceive'
...
;(function (GroupVerificationType) {
  GroupVerificationType[(GroupVerificationType['ApplyNeedInviteNot'] = 0)] =
    'ApplyNeedInviteNot'
...
;(function (ApplicationHandleResult) {
  ApplicationHandleResult[(ApplicationHandleResult['Unprocessed'] = 0)] =
    'Unprocessed'
...
;(function (MessageType) {
  ...
  MessageType[(MessageType['GroupOwnerTransferred'] = 1507)] =
  ...
  MessageType[(MessageType['GroupMemberInfoUpdated'] = 1516)] =
  ...
  MessageType[(MessageType['GroupAnnouncementUpdated'] = 1519)] =
  ...
  MessageType[(MessageType['HasReadReceiptMessage'] = 2150)] =
    'HasReadReceiptMessage'
  MessageType[(MessageType['GroupHasReadReceipt'] = 2155)] =
    'GroupHasReadReceipt'
